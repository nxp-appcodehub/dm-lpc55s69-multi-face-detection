...
void BOARD_InitPins(void)
{
    ...
    IOCON_PinMuxSet(IOCON, 0U, 10U, port0_pin10_config);
		...
		const uint32_t port0_pin13_config = (/* Pin is configured as SWO */
                                         IOCON_PIO_FUNC0 |
                                         /* No addition pin function */
                                         IOCON_PIO_MODE_INACT |
                                         /* Standard mode, output slew rate control is enabled */
...
/* CLOCK OUT */
    ...
    const uint32_t port0_pin16_config = (/* Pin is configured as CLOCKOUT */
                                         2 | /* function 2*/
                                         /* No addition pin function */
                                         IOCON_PIO_MODE_INACT |
                                         /* Standard mode, output slew rate control is enabled */
    ...
    const uint32_t port1_pin1_config = (/* Pin is configured as LSPI_HS_SSEL1 */
                                         ...
                                         /* Open drain is disabled */
                                         IOCON_PIO_OPENDRAIN_DI);
    /* PORT3 PIN30 (coords: K13) is configured as FC9_CTS_SDA_SSEL1 */
    ...
    const uint32_t port0_pin17_config = (/* Pin is configured as PIO0_17 */
                                         ...
                                         /* Open drain is disabled */
                                         IOCON_PIO_OPENDRAIN_DI);
    /* PORT0 PIN17 (coords: 9) is configured as PIO0_17 */
